...
async def test_complete_system():
    ...
    try:
        ...
        discovery_task = asyncio.create_task(discovery_scanner.scan_live_discoveries(max_discoveries=10))
        ...
        gems, discoveries, analysis = await asyncio.gather(gem_task, discovery_task, goodbuy_task)
